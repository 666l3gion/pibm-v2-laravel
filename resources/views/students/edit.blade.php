...
<div class="container-xl">
    ...
    <div class="page-header d-print-none">
        ...
        <div class="row">
            <div class="col-md-6">
                <form action="{{ route('master.students.update', ['student' => $student->id]) }}" method="post"
                    class="form-disable">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="card mb-2">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <x-forms.input :required="true" name="nis" label="NIS"
                                    ...
                                    <x-forms.input :required="true" name="email" label="Email Siswa"
                                        old="{{ old('email',$student->email) }}" />
                                    <x-forms.select :required="true" name="gender" label="Jenis Kelamin"
                                        placeholder="Pilih jenis kelamin">
                                        <option @if( old('gender', $student->gender) === "L") selected @endif
                                            value="L">Laki-laki
                                        </option>
                                        <option @if( old('gender', $student->gender) === "P") selected @endif
