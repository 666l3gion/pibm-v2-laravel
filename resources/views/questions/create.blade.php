...
<div class="container-xl">
    ...
    <div class="page-header d-print-none">
        ...
        <div class="row">
            <div class="col-md-9">
                <form action="{{ route('questions.store') }}" method="post" class="form-disable"
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <div id="option-a-editor" class="w-100">{!! old("option_a")
                                            !!}</div>
                                        <input type="hidden" name="option_a" id="option_a" value="{{ old('option_a')
                                            }}" />
                                        @error("option_a")
                                        <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <div id="option-b-editor" class="w-100">{!! old("option_b")
                                            !!}</div>
                                        <input type="hidden" name="option_b" id="option_b" value="{{ old('option_b')
                                            }}" />
                                        @error("option_b")
                                        <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <div id="option-c-editor" class="w-100">{!! old("option_c")
                                            !!}</div>
                                        <input type="hidden" name="option_c" id="option_c" value="{{ old('option_c')
                                            }}" />
                                        @error("option_c")
                                        <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <div id="option-d-editor" class="w-100">{!! old("option_d")
                                            !!}</div>
                                        <input type="hidden" name="option_d" id="option_d" value="{{ old('option_d')
                                            }}" />
                                        @error("option_d")
                                        <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <div id="option-e-editor" class="w-100">{!! old("option_e")
                                            !!}</div>
                                        <input type="hidden" name="option_e" id="option_e" value="{{ old('option_e')
                                            }}" />
                                        @error("option_e")
                                        <small class="text-danger">{{ $message }}</small>
                                        @enderror
